  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        display: ["32px", { lineHeight: "1.1", letterSpacing: "0", fontWeight: "700" }],
        h1: ["24px", { lineHeight: "1.2", letterSpacing: "0", fontWeight: "700" }],
        h2: ["18px", { lineHeight: "1.3", letterSpacing: "0", fontWeight: "600" }],
        h3: ["14px", { lineHeight: "1.4", fontWeight: "600" }],
        body: ["14px", { lineHeight: "1.45", fontWeight: "400" }],
        "body-lg": ["16px", { lineHeight: "1.5", fontWeight: "400" }],
        label: ["11px", { lineHeight: "1.3", letterSpacing: "0", fontWeight: "600" }],
        caption: ["11px", { lineHeight: "1.3", fontWeight: "400" }],
        "num-xl": ["28px", { lineHeight: "1", letterSpacing: "0", fontWeight: "700" }],
