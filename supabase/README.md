...
- Site URL: `https://landing-two-dun-95.vercel.app/auth/confirmed`
- Redirect URLs:
  - `https://landing-two-dun-95.vercel.app/auth/confirmed`
  - `https://landing-two-dun-95.vercel.app/**`

If the confirmation email opens `localhost`, this setting is still pointing to the default local URL or the email was generated by an older app build before `v0.2.17`.
