...
<body>
  <div class="card">
    ...
    <h1>Η συνδρομή καταχωρήθηκε!</h1>
    <p>
      Η πληρωμή ολοκληρώθηκε και η συνδρομή σου θα ενεργοποιηθεί από το webhook.
      Επέστρεψε στην εφαρμογή για να δεις το ενημερωμένο πλάνο.
    </p>
